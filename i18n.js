...
(function () {
  ...
  const I18N = {
    it: {
      ...
      hp_bullet_3:         "<strong>Messo alla prova, anche dove perde</strong> — 15 verifiche con intervalli bootstrap al 95%, compreso il confronto out-of-sample con baseline banali: contro l'output grezzo per-90 il TPI non vince",
      ...
      hp_card_val_body:    "15 verifiche riportate come sono uscite: confronto con baseline banali, calibrazione, ablation delle 7 dimensioni, predittività per ruolo, convergenza e persistenza.",
    ...
    en: {
      ...
      hp_bullet_3:         "<strong>Tested, including where it loses</strong> — 15 checks with 95% bootstrap intervals, including the out-of-sample comparison against trivial baselines: against raw per-90 output the TPI does not win",
      ...
      hp_card_val_body:    "15 checks reported exactly as they came out: comparison against trivial baselines, calibration, ablation of the 7 dimensions, predictivity by role, convergence and persistence.",
