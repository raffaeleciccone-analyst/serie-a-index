...
(function () {
  ...
  const I18N = {
    it: {
      ...
      val_ax_tpi_classic:  "TPI Classico (4 dim)",
      val_ax_tpi_pro:      "TPI Pro (6 dim)",
      ...
      dash_pro_mean6:      "media 6 z-score",
      dash_pro_gauss:      "Gaussiana picco 27 anni",
      dash_pro_avail:      "Disponibilità + infortuni + gravità",
      dash_pro_dims:       "Output · Centralità · Boost · Consistenza",
      ...
      dash_meth_intro:     "Il TPI misura l'impatto offensivo reale attraverso 4 dimensioni ortogonali. Bayesian shrinkage stabilizza le stime. SOS-weighting normalizza la difficoltà.",
    ...
    en: {
      ...
      dash_tab_radar:      "Radar",
      dash_pro_mean6:      "mean of 6 z-scores",
      dash_pro_gauss:      "Gaussian, peak at 27",
      dash_pro_avail:      "Availability + injuries + severity",
      dash_pro_dims:       "Output · Centrality · Boost · Consistency",
      ...
      dash_meth_intro:     "TPI measures real offensive impact through 4 orthogonal dimensions. Bayesian shrinkage stabilizes the estimates. SOS-weighting normalizes difficulty.",
