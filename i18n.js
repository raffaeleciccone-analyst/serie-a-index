...
(function () {
  ...
  const I18N = {
    it: {
      ...
      hp_bullet_1:         "<strong>7 dimensioni indipendenti</strong> — output, buildup, centralità, boost, consistenza (su IQR), finishing e forma recente, standardizzate con <strong>z-score winsorizzati</strong>. I 4 modulatori scout (AII, PRI, stabilità, trend) entrano nel TPI Pro",
    ...
    en: {
      ...
      hp_bullet_1:         "<strong>7 independent dimensions</strong> — output, buildup, centrality, boost, consistency (IQR-based), finishing and recent form, standardized with <strong>winsorized z-scores</strong>. The 4 scout modulators (AII, PRI, stability, trend) feed TPI Pro",
