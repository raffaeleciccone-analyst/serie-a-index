...
| [Data (CSV)](https://raffaeleciccone-analyst.github.io/serie-a-index/serie_a_tpi_2026-27.csv) | Every qualified player, every column the engine writes, refreshed on every run |
